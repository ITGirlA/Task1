...
@NgModule({
  declarations: [HeaderComponent, BreadcrumbsComponent, ToolboxComponent, CoursesListComponent, FooterComponent, FakeLogoComponent, CoursesListItemComponent, UserLoginComponent, LogOffComponent, SearchFieldComponent, SearchButtonComponent, AddButtonComponent],
  imports: [
    CommonModule
  ],
